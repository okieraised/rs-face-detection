...
mod tests {
    use std::collections::HashMap;
    use ndarray::array;
    use crate::processing::generate_anchors::{_ratio_enum, _scale_enum, AnchorConfig, Config, generate_anchors, generate_anchors2, generate_anchors_fpn, generate_anchors_fpn2};
